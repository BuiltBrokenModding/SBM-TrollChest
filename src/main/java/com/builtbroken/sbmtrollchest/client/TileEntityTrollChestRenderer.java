...
public class TileEntityTrollChestRenderer extends TileEntitySpecialRenderer<TileEntityTrollChest> //copied from TileEntityChestRenderer
{
    ...
    public TileEntityTrollChestRenderer()
    {
    ...
    public void render(TileEntityTrollChest te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
