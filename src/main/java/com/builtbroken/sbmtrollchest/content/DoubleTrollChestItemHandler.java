...
public class DoubleTrollChestItemHandler extends WeakReference<TileEntityTrollChest> implements IItemHandlerModifiable //copied from VanillaDoubleChestItemHandler
{
    // Dummy cache value to signify that we have checked and definitely found no adjacent chests
    public static final DoubleTrollChestItemHandler NO_ADJACENT_CHESTS_INSTANCE = new DoubleTrollChestItemHandler(null, null, false);
    private final boolean mainChestIsUpper;
    private final TileEntityTrollChest mainChest;
    private final int hashCode;

    public DoubleTrollChestItemHandler(@Nullable TileEntityTrollChest mainChest, @Nullable TileEntityTrollChest other, boolean mainChestIsUpper)
    {
        super(other);
    ...
    @Nullable
    public static DoubleTrollChestItemHandler get(TileEntityTrollChest chest)
    {
        ...
        for (int i = horizontals.length - 1; i >= 0; i--)   // Use reverse order so we can return early
        {
            ...
            if (block == blockType)
            {
                ...
                if (otherTE instanceof TileEntityTrollChest)
                {
                    TileEntityTrollChest otherChest = (TileEntityTrollChest) otherTE;
                    return new DoubleTrollChestItemHandler(chest, otherChest,
    ...
    @Nullable
    public TileEntityTrollChest getChest(boolean accessingUpper)
    {
    ...
    @Nullable
    private TileEntityTrollChest getOtherChest()
    {
        TileEntityTrollChest tileEntityChest = get();
    ...
    public ItemStack getStackInSlot(int slot)
    {
        ...
        TileEntityTrollChest chest = getChest(accessingUpperChest);
    ...
    public boolean equals(Object o)
    {
        ...
        DoubleTrollChestItemHandler that = (DoubleTrollChestItemHandler) o;

        if (hashCode != that.hashCode)
            return false;

        final TileEntityTrollChest otherChest = getOtherChest();
